...
public class SampleContentFragment {
 public static final String MODEL_TITLE = "Demo Book";
 public static final String CF_PATH = "/content/dam/aem-quickstart/demo-book";
 ...
 public Calendar getReleaseDate() {
  return ((Calendar) contentFragment.map(cf -> cf.getElement("realeaseDate")).map(ContentElement::getValue)
